...
function sendNewItem(){
  ...
  let lost_or_found = 0; // found item
...
function searchResultsTimeRange() {
  ...
  // Fix this once google maps is working...
  ...
  window.location = "https://matthew-shayan-kasra-lost-and-found.glitch.me/user/searchResultsFinder.html";
}
